    ...
    <div className="min-h-screen bg-[#F7FFFD] relative overflow-hidden">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-8 pt-12 pb-20 text-center">
        <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#D9F5EF] text-[#2F5D57] text-xs font-semibold tracking-wider">
          <Heart className="w-3.5 h-3.5 text-[#5BB9A6]" strokeWidth={2} fill="none" /> MyHealthVoice Platform
        </span>
        <h1 className="mt-6 font-[Outfit] font-extrabold text-4xl sm:text-5xl lg:text-6xl tracking-tight max-w-5xl mx-auto leading-[1.05]">
          <span className="text-[#2F5D57]">Welcome to </span>
        ...
        <p className="mt-5 text-base sm:text-lg text-[#4B7A73] max-w-2xl mx-auto leading-relaxed">
          Select your portal to get started with your healthcare journey.
        </p>
        ...
        <div className="mt-12 grid sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          >
            ...
            <h3 className="mt-6 font-[Outfit] font-semibold text-2xl text-[#2F5D57]">Doctor Portal</h3>
            <p className="mt-2 text-sm text-[#4B7A73] leading-relaxed">
              Manage patients, review uploads, answer queries and get AI-assisted reply drafts — all in one workspace.
            </p>
            <div className="mt-6 flex flex-wrap gap-2">
              {["Dashboard", "Patients", "Uploads", "Queries"].map((t) => (
                <span key={t} className="text-xs px-3 py-1 rounded-full bg-[#A7E3D4]/40 text-[#2F5D57]">{t}</span>
              ))}
            </div>
          </Link>
          ...
          >
            ...
            <h3 className="mt-6 font-[Outfit] font-semibold text-2xl text-[#2F5D57]">Patient Portal</h3>
            <p className="mt-2 text-sm text-[#4B7A73] leading-relaxed">
              Read your reports in plain language, chat with an educational AI, and reach your doctor with a single message.
            </p>
            <div className="mt-6 flex flex-wrap gap-2">
              {["AI Assistant", "Records", "Ask Doctor", "Timeline"].map((t) => (
                <span key={t} className="text-xs px-3 py-1 rounded-full bg-[#A7E3D4]/40 text-[#2F5D57]">{t}</span>
              ))}
            </div>
          </Link>
