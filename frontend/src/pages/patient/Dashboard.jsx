    ...
    <div className="space-y-8">
      <div className="card-soft p-8 relative overflow-hidden">
        ...
        <div className="relative">
          <span className="inline-flex px-3 py-1 rounded-full bg-[#A7E3D4]/40 text-[#2F5D57] text-xs font-semibold uppercase tracking-wider">Welcome back</span>
          <h1 className="mt-3 font-[Outfit] text-3xl md:text-4xl font-bold text-[#2F5D57]">Hello, {patient.name.split(" ")[0]}</h1>
          <p className="text-[#4B7A73] mt-2 max-w-xl">Here's your health at a glance. Take a deep breath — you're doing great.</p>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-12 gap-6">
        <div className="lg:col-span-8 card-soft p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="font-[Outfit] text-xl font-semibold text-[#2F5D57]">Health summary</h3>
          </div>
          <div className="grid sm:grid-cols-3 gap-4">
            <div className="p-4 rounded-xl bg-[#F7FFFD]">
              ...
              <div className="mt-1 text-sm font-semibold text-[#2F5D57]">{patient.medications.join(", ") || "None"}</div>
            </div>
            <div className="p-4 rounded-xl bg-[#F7FFFD]">
              <AlertCircle className="w-4 h-4 text-[#E5A832] mb-2" />
              <div className="text-xs uppercase tracking-wider text-[#4B7A73]">Allergies</div>
              <div className="mt-1 text-sm font-semibold text-[#2F5D57]">{patient.allergies.join(", ") || "None"}</div>
            </div>
            <div className="p-4 rounded-xl bg-[#F7FFFD]">
              <HeartPulse className="w-4 h-4 text-[#2F5D57] mb-2" />
              <div className="text-xs uppercase tracking-wider text-[#4B7A73]">Conditions</div>
              <div className="mt-1 text-sm font-semibold text-[#2F5D57]">{patient.conditions.join(", ") || "None"}</div>
            </div>
          </div>
          <div className="mt-6 p-4 rounded-xl bg-[#A7E3D4]/30">
            <div className="flex items-center gap-2 text-xs uppercase tracking-wider text-[#4B7A73] font-semibold">
              <Sparkles className="w-3.5 h-3.5" /> Latest AI summary
            </div>
        ...
        <div className="lg:col-span-4 space-y-4">
          <div className="card-soft p-6">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="font-[Outfit] text-lg font-semibold text-[#2F5D57]">Upcoming</h3>
            </div>
            <div className="space-y-3">
              <div className="p-3 rounded-xl bg-[#F7FFFD]">
                <div className="text-xs text-[#4B7A73]">Tue, Mar 11 · 10:30 AM</div>
                <div className="text-sm font-semibold text-[#2F5D57]">Follow-up with Dr. Chen</div>
              </div>
              <div className="p-3 rounded-xl bg-[#F7FFFD]">
                <div className="text-xs text-[#4B7A73]">Fri, Mar 21</div>
                <div className="text-sm font-semibold text-[#2F5D57]">Quarterly lab work</div>
              </div>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-3">
            <Link to="/patient/ai-assistant" data-testid="quick-ask-ai" className="card-soft p-4 text-center group">
              ...
              <div className="mt-2 text-sm font-semibold text-[#2F5D57]">Ask AI</div>
            </Link>
            <Link to="/patient/ask-doctor" data-testid="quick-ask-doctor" className="card-soft p-4 text-center group">
              ...
              <div className="mt-2 text-sm font-semibold text-[#2F5D57]">Ask Doctor</div>
            </Link>
            <Link to="/patient/records" data-testid="quick-records" className="card-soft p-4 text-center group">
              ...
              <div className="mt-2 text-sm font-semibold text-[#2F5D57]">Documents</div>
            </Link>
            <Link to="/patient/records" data-testid="quick-upload" className="card-soft p-4 text-center group">
              ...
              <div className="mt-2 text-sm font-semibold text-[#2F5D57]">Upload</div>
            </Link>
          </div>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <div className="card-soft p-6">
          <h3 className="font-[Outfit] text-lg font-semibold text-[#2F5D57] mb-4">Recent updates</h3>
          {recent_threads.length === 0 ? (
            <p className="text-sm text-[#4B7A73]">Nothing new yet.</p>
          ) : (
        ...
        <div className="card-soft p-6">
          <h3 className="font-[Outfit] text-lg font-semibold text-[#2F5D57] mb-4">Recent documents</h3>
          {recent_documents.length === 0 ? (
            <p className="text-sm text-[#4B7A73]">No documents yet.</p>
          ) : (
            <ul className="space-y-3">
